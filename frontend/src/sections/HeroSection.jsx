...
function GitIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
      <path d="M22 11.4 12.6 2a1.8 1.8 0 0 0-2.6 0L7.8 4.2l2.8 2.8a2.1 2.1 0 0 1 2.6.4 2.1 2.1 0 0 1 .5 2.1l2.7 2.7a2.1 2.1 0 0 1 2.1.5 2.1 2.1 0 1 1-3.5 2.2 2.1 2.1 0 0 1 .5-2.2l-2.5-2.5v6.5a2.1 2.1 0 1 1-1.3 0v-6.6a2.1 2.1 0 0 1-1.1-3.4L6.9 5.1 2 10a1.8 1.8 0 0 0 0 2.6l9.4 9.4a1.8 1.8 0 0 0 2.6 0l8-8a1.8 1.8 0 0 0 0-2.6Z" />
    </svg>
  );
}
